...
function randomSelector(marray) {
  var randomNumber = Math.floor(Math.random() * (marray.length - 0));
  return marray[randomNumber];   
}
...
function revealMistery(pickMister) {
  return pickMister[0].first_name + " " + pickMister[0].last_name + " killed Mr.Boddy using the " + pickMister[1].name + " in the " + pickMister[2].name + "!!!!";
}